...
export const SupportCenterView: React.FC<SupportCenterViewProps> = ({
  ...
  const faqs = [
    {
      qAr: 'كيف يستند وكيل عرفات الذكي لإجابة الاستفسارات الدينية والمناسك؟',
      aAr: 'تعتمد جميع المخرجات والمعارف الفقهية والمناسك في منصة عرفات وفي الوكيل الذكي حصرياً على المصادر والمراجع الرسمية المعتمدة في المملكة العربية السعودية (مثل: وزارة الشؤون الإسلامية والدعوة والإرشاد، والرئاسة العامة للبحوث العلمية والإفتاء، ووزارة الحج والعمرة). وننوه إلى أن التطبيق رفيق إرشادي ومساعد ذكي ولا يغني عن الفتاوى الرسمية والاستفتاء المباشر من العلماء.',
    },
    {
